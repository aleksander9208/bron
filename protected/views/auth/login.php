<div id="z_page_auth" class="row">
    <div class="col">
        ...
        <p>Чтобы заполнить электронную форму заявки для бронирования путевки в&nbsp;детский лагерь отдыха в&nbsp;период летней кампании 2019&nbsp;года, нажмите кнопку &laquo;Подать заявку&raquo;. После подачи заявки, автоматически будет сформирован &laquo;Личный кабинет&raquo;.</p>
