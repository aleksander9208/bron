                    ...
                    if (parent_task_name != '')
                        {
                            if(typeof _self.data[parent_task_name] == 'object')
                                ...
                                _self.z.log(_self.name, 'add', 'Нет родительской задачи "'+parent_task_name+'" для задачи "'+name+'"!');
                        };
                    _self.z.log(_self.name, 'add', 'Создание новой задачи "'+name+'" ('+text+')!');
                    return name;
                },
                    ...
                    if (typeof _self.data[name] == 'object')
                        {
                            ...
                            _self.z.log(_self.name, 'remove', 'Задача "'+name+'" удалена!', 0);
                    ...
                    if (typeof _self.data[name] == 'object')
                        {
                            ...
                            if (link.length==0)
                                {
                                    _self.z.log(_self.name, 'call', 'Задача "'+name+'" выполнена! ('+_self.data[name].info+')');
                                    ...
                                    else
                                {
                                    ...
                                    _self.z.log(_self.name, 'call', 'Задача "'+name+'" отложена, до отработки задач: '+link.join(', ')+'!');
                                }
                        }
                            else
                        _self.z.log(_self.name, 'call', 'Вызов несуществующей задачи "'+name+'"!');
                    return out;
                },
