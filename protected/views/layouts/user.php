    ...
    <body id="fb_wrap" class="h-100">
        ...
        <nav id="fb_nav" class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
            ...
            <div class="collapse navbar-collapse" id="fb_nav_items">
                ...
                <?php $this->widget('application.extensions.panels.topClientPanel'); ?>


                <span id="fb_user_balance" class="nav-item font-italic mr-4">Баланс: <?php echo Yii::app()->user->id; ?></span>
